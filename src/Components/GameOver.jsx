...
export function GameOver({ finalScore }) {
  ...
  // Ajouter une nouvelle fonction pour effacer les scores
      ...
      <div className="flex flex-col items-center justify-center gap-4">
        ...
        {!isSubmitted ? (
          <form onSubmit={handleSubmit} className="mt-6 flex flex-col items-center gap-4">
            ...
            <div className="flex flex-row  w-[25vw] justify-between items-center">
              <button
                type="submit"
                className="brutal-shadow p-[15px] bg-[#f6f6f6] hover:bg-[#f72585] text-black hover:text-white font-bold transition-colors cursor-pointer border-4 border-[#000] drop-shadow-xl mt-4 active:shadow-none active:!shadow-none active:brutal-shadow:none active:translate-y-2 active:translate-x-2"
              >
              ...
              {highScores && highScores.length > 0 && (
                ...
                className="brutal-shadow-alert p-[15px] bg-[#f6f6f6] hover:bg-[#FF5252] text-black hover:text-white font-bold transition-colors cursor-pointer border-4 border-[#000] drop-shadow-xl mt-4 active:shadow-none active:!shadow-none active:brutal-shadow:none active:translate-y-2 active:translate-x-2"
              >
                Effacer les scores
              </button>
              )}
          ...
          <div className="mt-6 flex flex-col items-center ">
            ...
            <div className="flex flex-row items-center gap-[2vw]">
              <div className=" flex flex-col items-center">
                ...
                <Link
                  to="/game"
                  className="hover:-rotate-5 hover:duration-300 duration-300 brutal-shadow p-[15px] bg-[#f6f6f6] hover:bg-[#f72585] text-black hover:text-white font-bold transition-colors cursor-pointer border-4 border-[#000] drop-shadow-xl mt-4 no-underline inline-block text-center active:shadow-none active:!shadow-none active:brutal-shadow:none active:translate-y-2 active:translate-x-2"
                >
                  Rejouer
                </Link>
              </div>
        ...
        <div className="mt-8 w-full max-w-md">
          ...
          {highScores.length > 0 ? (
            <div className="bg-gray-100 brutal-shadow p-[15px] bg-[#f6f6f6] text-black  font-bold transition-colors cursor-pointer border-4 border-[#000] drop-shadow-xl mt-4 no-underline inline-block text-center overflow-hidden">
